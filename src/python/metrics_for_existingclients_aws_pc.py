...
sch = "arkvalley" #"fcc" #"form_477_201712"
...
def driveLoop():
	...
	print ('sub_feeder,substation_name,substation#,feeder#,oh_primary_ft,oh_secondary_ft,ug_primary_ft,ug_secondary_ft,oh_primary_mi,oh_secondary_mi,ug_primary_mi,ug_secondary_mi,total_primary_miles,total_secondary_miles,meters,primary_poles,total_poles')
	...
	for driveRow in driveCur:
		...
		# print (meters)
		primPoles = returnPrimaryStructures(aSub, aFeed)
		# primTrans =returnPrimaryStructures (aSub, aFeed, 'primU')
		#print total primary poles and transformers
		totPoles = returnStructures(aSub, aFeed)
		# ugtransformers = returnStructures(aSub, aFeed, 'u')
		#print(ugtrans)

		print (aSub + "-" + aFeed,subName,aSub,aFeed,aerial,aerial2,ug,ug2,a_miles,a_miles2,ug_miles,ug_miles2,totMiles,totMiles2,meters,primPoles,totPoles)
...
def returnPrimaryStructures(mySub, myFeed):
	if spanTB + "." + "subtype = 1 ":
	...
	# aSQL = aSQL + qry + " "
	aSQL = aSQL + "AND ST_DWithin(" + structureTB + "." + "geom" + "," + spanTB + "." + "geom" + "," + searchDist + ") "
	# aSQL = aSQL + subQRY
	aSQL = aSQL + "; "
...
def returnStructures(mySub, myFeed):
	# if ugtrans == 'p':
	# 	qry = '0'
	# if ugtrans == 'u':
	# 	qry = '1'

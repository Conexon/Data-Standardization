...
---------------
  - ```Update schema.table
      Set column = another_column, column = <‘string’>, column = <an integer> string, another column’s values, a numeric value, etc.```  - let’s you change records to be a specific 
...
- this allows you to create a new table where there is a spatial relationship between the two tables.       
